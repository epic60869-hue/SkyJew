...
public final class SkyBallsAlerts {
    private static final Identifier ANIMATION_ID = Identifier.fromNamespaceAndPath("skyballs", "drop_animation");
