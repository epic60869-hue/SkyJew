...
public final class PickaxeAbility {
    ...
    private static void tick() {
        ...
        SkyBallsTabWidgetManager.Widget widget = SkyBallsTabWidgetManager.get("Pickaxe Ability");
        ...
        for (String raw : texts) {
            String text = SkyBallsLocation.strip(raw).trim();
    ...
    private static void alert() {
        ...
        if (c != null && c.pickaxeAbilityAlert && inMiningArea()) {
            SkyBallsAlerts.title(Component.literal(ability + " Ready!").withStyle(ChatFormatting.GREEN, ChatFormatting.BOLD), Component.empty());
        }
    }
