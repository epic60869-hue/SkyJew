...
public final class CrystalHollowsWaypoints {
    ...
    private static boolean enabled() {
        ...
        return c != null && c.crystalWaypoints && SkyBallsLocation.inCrystalHollows();
    }
    ...
    public static void init() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(mc -> {
            ...
            Place here = Place.of(SkyBallsLocation.location());
                ...
                dispatcher.register(ClientCommands.literal(root).then(ClientCommands.literal("crystalwaypoints")
                    .then(ClientCommands.literal("add")
                        .executes(c -> {
                            ...
                            if (p != null) SkyBallsAlerts.chat(placeMenu(p.blockPosition()));
                            return 1;
                        })
    ...
    private static void onChat(String text) {
        ...
        SkyBallsAlerts.chat(placeMenu(pos));
    }
