 ...
 */
public final class SkyBallsNickFilter {
    ...
    public static boolean impersonatesStaff(String name, java.util.UUID owner) {
        ...
        for (String word : SkyBallsStaff.roleWords(owner)) if (letters.contains(word)) return true;
        for (String staff : SkyBallsStaff.names(owner)) {
