 ...
 */
public final class SkyBallsNickScreen extends Screen {
    ...
    private SkyBallsNickFonts.NickFont nickFont = SkyBallsNickFonts.NickFont.DEFAULT;

    // Panel rectangles, recomputed in layout().
    private int leftX, midX, rightX, panelY, panelH, leftW, midW, rightW;

    public SkyBallsNickScreen(Screen parent) {
        ...
        if (config != null) {
            ...
            nickFont = SkyBallsNickFonts.parse(config.misc.nickname.font);
        }
    }
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.literal("Remove Nickname").withStyle(ChatFormatting.RED), b -> {
            ...
            style = "Plain";
            customHex = "";
            nickFont = SkyBallsNickFonts.NickFont.DEFAULT;
            rebuildWidgets();
        ...
        addRenderableWidget(Button.builder(SkyBallsNick.styled("Rainbow", "Rainbow", ""), b -> {
            style = "Rainbow";
            customHex = "";
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
        ...
        Component name = SkyBallsNick.styled(previewName(), style, customHex, nickFont.label);
        int py = panelY + 30;
        int px = rightX + 8;
    ...
    private boolean save() {
        ...
        if (config != null) {
            ...
            if (SkyBallsNickFilter.isBlocked(name, minecraft.getUser().getProfileId())) {
    ...
    private final class FontButton extends AbstractWidget {
        ...
        protected void extractWidgetRenderState(GuiGraphicsExtractor g, int mouseX, int mouseY, float delta) {
            ...
            Component label = SkyBallsNick.styled(nickFont.label, "White", "", nickFont.label);
        ...
        public void onClick(MouseButtonEvent click, boolean doubled) {
            if (click.x() < getX() + width / 2.0) {
                SkyBallsNickFonts.NickFont[] all = SkyBallsNickFonts.NickFont.values();
