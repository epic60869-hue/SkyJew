...
/**
 * SkyBalls's TAB parser follows Skyblocker's widget-boundary approach rather than
 ...
 */
public final class SkyBallsTabWidgetManager {
    ...
    private SkyBallsTabWidgetManager() {}
    ...
    private static void update(Minecraft mc) {
        ...
        try {
            ordered.sort(SkyBallsPlayerTabOverlayAccessor.getOrdering());
