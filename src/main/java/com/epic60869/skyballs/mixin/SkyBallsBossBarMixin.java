...
import com.epic60869.skyballs.features.dungeons.BloodCamp;
...
public abstract class SkyBallsBossBarMixin {
    ...
    private Component skyballs$watcherBar(Component name, @Local LerpingBossEvent event) {
