...
public final class SkyBallsDiscordScreen extends Screen {
    private static SkyBallsDiscordScreen active;
    ...
    public SkyBallsDiscordScreen(Screen previousScreen) {
    ...
    public static void handleResult(String requestId, boolean ok, JsonObject result, String detail) {
        SkyBallsDiscordScreen screen = active;
    ...
    private void requestChannels(String guildId, String guildName) {
        ...
        SkyBallsGlobalChat.requestDiscord("channels", data);
    }
    ...
    private void requestMessages(String channelId, String channelName) {
        ...
        SkyBallsGlobalChat.requestDiscord("messages", data);
    }
    ...
    private void requestDm(String userId, String userName) {
        ...
        SkyBallsGlobalChat.requestDiscord("openDm", data);
    }
