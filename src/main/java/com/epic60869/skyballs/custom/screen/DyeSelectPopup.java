...
import com.epic60869.skyballs.custom.RepoDyeColors;
...
public class DyeSelectPopup extends AbstractPopupScreen {
	...
	protected DyeSelectPopup(Screen backgroundScreen, BiConsumer<Button, Integer> updateStatic, AnimatedDyeConsumer updateAnimated) {
		super(Component.translatable("skyballs.customization.armor.pickDye"), backgroundScreen);
	...
	protected void init() {
		...
		layout.addChild(new StringWidget(Component.translatable("skyballs.customization.armor.pickDye.dyes", Component.translatable("skyballs.customization.armor.pickDye.dyes.static")), font), headerLayout);
		...
		layout.addChild(new StringWidget(Component.translatable("skyballs.customization.armor.pickDye.dyes", Component.translatable("skyballs.customization.armor.pickDye.dyes.animated")), font), headerLayout);
		...
		titleWidget = new StringWidget(Component.translatable("skyballs.customization.armor.pickDye.title"), font);
