...
import com.epic60869.skyballs.mixin.SkyBallsInventoryScreenInvoker;
...
public class PlayerWidget extends AbstractWidget {
	...
	protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
		...
		EntityRenderState renderState = SkyBallsInventoryScreenInvoker.invokeExtractRenderState(this.player);
