...
import com.epic60869.skyballs.sb.events.SkyblockEvents;
import com.epic60869.skyballs.sb.skyblock.dungeon.secrets.DungeonManager;
import com.epic60869.skyballs.sb.skyblock.tabhud.util.PlayerListManager;
import com.epic60869.skyballs.sb.utils.Constants;
import com.epic60869.skyballs.sb.utils.ItemUtils;
import com.epic60869.skyballs.sb.utils.ProfileUtils;
import com.epic60869.skyballs.sb.utils.Utils;
import com.epic60869.skyballs.sb.utils.mayor.MayorUtils;
...
public class DungeonScore {
	...
	public static void tick() {
		...
		if (!sent270 && !sent300 && score >= 270 && score < 300) {
			...
			if (SCORE_CONFIG.get().enableDungeonScore270Title) {
				com.epic60869.skyballs.features.core.SkyBallsAlerts.chat(Component.literal("270 score reached in " + formatRunTime() + "!").withStyle(net.minecraft.ChatFormatting.YELLOW));
			}
			sent270 = true;
		}
		...
		if (!sent300 && score >= 300) {
			...
			if (SCORE_CONFIG.get().enableDungeonScore300Title) {
				com.epic60869.skyballs.features.core.SkyBallsAlerts.chat(Component.literal("300 score reached in " + formatRunTime() + "!").withStyle(net.minecraft.ChatFormatting.GREEN));
			}
			sent300 = true;
		}
	}
	...
	// SkyBalls: read by the score display and score alerts.
