package com.epic60869.skyballs.sb.skyblock.experiment;
...
public final class UltrasequencerSolver extends ExperimentSolver {
	...
	/** Draws each remaining slot's place in the order; the next one is yellow. (SkyBalls addition.) */
	private void renderNumbers(AbstractContainerScreen<?> screen, GuiGraphicsExtractor graphics) {
		var config = com.epic60869.skyballs.SkyBallsConfig.current();
