...
public final class GuiHelper {
	...
	public static void border(GuiGraphicsExtractor context, int x, int y, int width, int height, int color) {
		com.epic60869.skyballs.custom.util.GuiHelper.border(context, x, y, width, height, color);
	}
	...
	/** Skyblocker blurs the map background; SkyBalls draws a translucent fill instead. */
