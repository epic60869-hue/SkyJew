 ...
 */
public final class SkyBallsPriceTooltip {
    ...
    private static void addPrices(SkyBallsConfig.PriceTooltip config, ItemStack stack, List<Component> lines) {
