...
public class AnimatedDyeTimelineWidget extends AbstractContainerWidget implements Closeable {
	private static final Identifier GRADIENT_TEXTURE = Compat.id("generated/dye_gradient");
	...
	public void setAnimatedDye(String uuid) {
		this.uuid = uuid;
		CustomArmorAnimatedDyes.AnimatedDye dye = CustomConfigManager.get().general.customAnimatedDyes.get(uuid);
		keyframes.clear();
	...
	private void dataChanged() {
		...
		CustomConfigManager.updateOnly(config -> config.general.customAnimatedDyes.put(uuid, newDye));
	}
