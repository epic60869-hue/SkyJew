...
public class ColorPopup extends AbstractPopupScreen {
	...
	protected void init() {
		...
		addRenderableWidget(adder.addChild(new StringWidget(Component.translatable("skyjew.customItemNames.screen.customColorTitle"), font), 2));
		if (gradient) {
	...
	private void createLayoutGradient(GridLayout.RowHelper adder) {
		...
		addRenderableWidget(adder.addChild(new StringWidget(Component.translatable("skyjew.customItemNames.screen.gradientStart"), font)));
		addRenderableWidget(adder.addChild(new StringWidget(Component.translatable("skyjew.customItemNames.screen.gradientEnd"), font)));
