...
import com.epic60869.skyjew.mixin.SkyJewInventoryScreenInvoker;
...
public class PlayerWidget extends AbstractWidget {
	...
	protected void extractWidgetRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
		...
		EntityRenderState renderState = SkyJewInventoryScreenInvoker.invokeExtractRenderState(this.player);
