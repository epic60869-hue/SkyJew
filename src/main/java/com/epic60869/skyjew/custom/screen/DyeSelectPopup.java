...
import com.epic60869.skyjew.custom.util.AbstractPopupScreen;
...
public class DyeSelectPopup extends AbstractPopupScreen {
	...
	protected DyeSelectPopup(Screen backgroundScreen, BiConsumer<Button, Integer> updateStatic, AnimatedDyeConsumer updateAnimated) {
		super(Component.translatable("skyjew.customization.armor.pickDye"), backgroundScreen);
	...
	protected void init() {
		...
		layout.addChild(new StringWidget(Component.translatable("skyjew.customization.armor.pickDye.dyes", Component.translatable("skyjew.customization.armor.pickDye.dyes.static")), font), headerLayout);
		...
		layout.addChild(new StringWidget(Component.translatable("skyjew.customization.armor.pickDye.dyes", Component.translatable("skyjew.customization.armor.pickDye.dyes.animated")), font), headerLayout);
		...
		titleWidget = new StringWidget(Component.translatable("skyjew.customization.armor.pickDye.title"), font);
	...
	private static class StaticDyeButton extends Button.Plain {
		...
		protected StaticDyeButton(String dyeId, int color, OnPress onPress) {
			...
			name = dyeId;
			String displayName = RepoItems.displayName(dyeId);
			if (displayName != null) name = ChatFormatting.stripFormatting(displayName);
			dyeStack = RepoItems.itemStack(dyeId);
