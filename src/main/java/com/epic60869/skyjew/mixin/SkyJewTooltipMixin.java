...
public abstract class SkyJewTooltipMixin {
    ...
    private Vector2ic skyjew$scrollTooltip(Vector2ic position, Font font, List<ClientTooltipComponent> lines, int xo, int yo, ClientTooltipPositioner positioner, Identifier style, boolean extraSpaceAfterFirstLine) {
        int width = 0;
        int height = extraSpaceAfterFirstLine && lines.size() != 1 ? 0 : -2;
