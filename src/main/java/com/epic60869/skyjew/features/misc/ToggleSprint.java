...
public final class ToggleSprint {
    ...
    public static void registerKey() {
        key = KeyMappingHelper.registerKeyMapping(new KeyMapping("key.skyjew.toggle_sprint", InputConstants.Type.KEYBOARD, InputConstants.UNKNOWN.getValue(), SkyJewKeyMappings.CATEGORY));
    }
