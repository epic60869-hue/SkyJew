...
public final class SlotLocking {
    ...
    private static SkyJewConfig.SlotLocking config() {
    ...
    public static boolean isLocked(int inventoryIndex) {
        SkyJewConfig.SlotLocking c = config();
    ...
    private static boolean keyPressed(AbstractContainerScreen<?> screen, int key) {
        ...
        Slot hovered = ((SkyJewContainerScreenAccessor) screen).skyjew$getHoveredSlot();
        if (key == c.lockKey) {
    ...
    private static void render(AbstractContainerScreen<?> screen, GuiGraphicsExtractor g, int mouseX, int mouseY) {
        ...
        SkyJewContainerScreenAccessor access = (SkyJewContainerScreenAccessor) screen;
        int left = access.skyjew$getLeftPos();
        int top = access.skyjew$getTopPos();
        ...
        Slot hovered = access.skyjew$getHoveredSlot();
