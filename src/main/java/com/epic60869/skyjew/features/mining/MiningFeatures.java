...
public final class MiningFeatures {
    ...
    public static void init() {
        ...
        SkyJewHuds.registerCustom("ch_map", "Crystal Hollows Map",
            () -> config() != null && config().crystalHollowsMap,
            new CrystalHollowsMap(), 8, 480);
        SkyJewHuds.register("mineshaft", "Mineshaft Timer",
    ...
    private static void tick(Minecraft mc) {
        ...
        if (SkyJewLocation.inCrystalHollows()) {
            ...
            if (config.divanToolsAlert && !divanAlerted && hasAllDivanTools(mc)) {
                divanAlerted = true;
                SkyJewAlerts.title(Component.literal("ALL 4 TOOLS!").withStyle(ChatFormatting.GREEN, ChatFormatting.BOLD),
    ...
    private static final class CrystalHollowsMap implements SkyJewHuds.CustomHud {
        @Override
        ...
        public boolean visible() {
            return SkyJewLocation.inCrystalHollows();
        }
        ...
        public void render(GuiGraphicsExtractor g, boolean preview) {
            ...
            if (player != null && (!preview || SkyJewLocation.inCrystalHollows())) {
