package com.epic60869.skyjew.sb.skyblock.dungeon.puzzle;
...
import com.epic60869.skyjew.sb.utils.Resettable;
import com.epic60869.skyjew.sb.utils.Tickable;
import com.epic60869.skyjew.sb.utils.render.Renderable;
...
public abstract class DungeonPuzzle implements Tickable, Renderable, Resettable {
	...
	public DungeonPuzzle(String puzzleName, Set<String> roomNames) {
		...
		ClientCommandRegistrationCallback.EVENT.register((dispatcher, _) -> dispatcher.register(literal("sj").then(literal("dungeons").then(literal("puzzle").then(literal(puzzleName).then(literal("solve").executes(context -> {
