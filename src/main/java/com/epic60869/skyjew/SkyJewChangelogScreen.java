 ...
 */
public final class SkyJewChangelogScreen extends Screen {
    ...
    private final List<SkyJewChangelog.Version> versions;
    ...
    private void layoutLines() {
        ...
        boolean first = true;
        for (SkyJewChangelog.Section section : version.sections()) {
