...
public final class SkyJewMouseLock {
    ...
    public static void tick(Minecraft mc) {
        boolean shouldLock = config != null && config.visual.mouseLockEnabled && mc.player != null
            && (!config.visual.mouseLockGroundOnly || mc.player.onGround())
