...
### Changed
- SkyJew now runs on Minecraft 26.3. MoulConfig (the settings screen) has no 26.3 release yet, so SkyJew ships its own 26.3 build of it (see `libs/moulconfig-26.3/`).
